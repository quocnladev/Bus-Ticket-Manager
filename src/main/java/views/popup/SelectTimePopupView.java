...
import views.TimeRenderJList;

public class SelectTimePopupView extends javax.swing.JFrame {

    DefaultListModel<Time> timeListModel = new DefaultListModel<>();

    public SelectTimePopupView() {
        initComponents();
        listTime.setModel(timeListModel);
        listTime.setCellRenderer(new TimeRenderJList());
        setPreferredSize(new Dimension(400, 500));
        getRootPane().setDefaultButton(btnSearch);
        setLocationRelativeTo(null);
    }

    public DefaultListModel<Time> getTimeDefaultListModel() {
    ...
    public JList<Time> getListTime() {
        return listTime;
    }

    public void setListTime(JList<Time> listTime) {
        this.listTime = listTime;
    }

    public void renderTime(ArrayList<Time> times) {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.weightx = 0.1;
        jPanel4.add(txtTime, gridBagConstraints);
    ...
    private javax.swing.JList<Time> listTime;
